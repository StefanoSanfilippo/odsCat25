...
output: 
  flexdashboard::flex_dashboard:
    ...
    self_contained: no
    navbar:
        - { title: "* Veure versió de 2024 del visor", href: "https://analysis.cat/ods/odscatalunya.html", align: "left", target: "_blank" }
---
<div class= "header">
<p class="left-side">
Els ODS als municipis de Catalunya - Actualització 2025
</p>
<span class="right-side"> <a href="https://gaiacooperacion.net" target="_blank" style="color: white; font-size:12pt; font-weight:normal; position:absolute; top:0px; right:350px;">Disseny:<img src="gaiaTransp45.png"/></a> <a href="https://dialoguia.cat" target="_blank" style="color: white; font-size:12pt; font-weight:normal; position:absolute; top:10px; right:130px;">Concepte:&nbsp;<img src="dialoguia45.png"/></a>
<a href="https://analysis.cat" target="_blank"><img src="icons8-home-30.png" height="30" style= "position:absolute;top:10px;right:67px;" /></a>
<a href="https://github.com/StefanoSanfilippo/odsCat25/" target="_blank"><img src="github40.png" height="30" style= "position:absolute;top:10px;right:10px;" /></a>
</span>
</div>
...
### Taxa bruta de mortalitat 2023<br> <d style= "font-size: 10px;">Defuncios / 1000 habitants</d> <br> <c style= "font-size: 10px;"> <i>Elaboració pròpia sobre microdades defuncions (INE) (2023)</i></c>
...
## Column {.tabset}
### Esperança de vida en néixer 2023<br> <d style= "font-size: 10px;">Mètode PH-England (Eayres and Williams, 2004)</d><br> <c style= "font-size: 10px;"> <i>Elaboració pròpia sobre microdades de defuncions (INE) i de població (IDESCAT)</i></c>
...
tm_shape(ods3EV_sf)+
    tm_fill(col= "ods3.EV",
            ...
            legend.format = list(text.separator= '-'),
            textNA = 'Sense dades',
            popup.vars=c("Esperança de vida en néixer (anys): " = "ods3.EV"),
            popup.format = list(
...
ods8.pib <- read_xlsx("BasesdeDatos/ODS8/pibc-13830-14779-mun.xlsx",
    ...
    mutate(ine= str_sub(...1,2,6),
           ...
           ods8.tasPib= (`2022`-`2021`)/`2021`*100) %>% 
    select(4,5,6,2,3) %>% 
    rename(pib2021= `2021`,
           pib2022= `2022`)
...
### Índex Gini (2022) <br> <c style= "font-size: 10px;"><i>Elaboració pròpia sobre dades de l'INE (2022)</i></c>
...
tm_shape(ods13.GCM_sf)+
    tm_fill(col= "ods13.Participa",
            ...
            title = "Participació en el Global Covenant",
            legend.format = list(text.separator= '-',
                                 decimal.mark= ","),
            textNA = 'Sense dades',
...
# Es recupera el padró més antic que tenim
