#==========================================
# Política de despesa 17. Medi ambient 2023
# =========================================
...
tb_inventario <-read.delim("./BasesdeDatos/ODS1/Liquidaciones2023/tb_inventario.txt",
                           sep = ";", dec = ",", header = FALSE)
...
writexl::write_xlsx(desp17, 'BasesdeDatos/ODS13/desp17MediAmb-2023.xlsx')
