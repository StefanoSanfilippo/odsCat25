#=====================================
# Política de despesa 17. Medi ambient 2021
# ====================================
...
tb_inventario <-read.delim("./BasesdeDatos/ODS1/Liquidaciones2021/tb_inventario.txt",
                           sep = ";", dec = ",", header = FALSE)
...
tb_funcional_cons <- tb_funcional_cons |> 
    ...
    filter(V3== 17) |>  # Se filtra la Política 17 Medio Ambient
...
desp17 <- tb_funcional_cons |> 
    inner_join(tb_inventario, by= c('Id'='Idente')) |> 
    mutate(anyo= '2021')

writexl::write_xlsx(desp17, 'BasesdeDatos/ODS13/desp17MediAmb-2021.xlsx')
